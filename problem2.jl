...
# ╔═╡ c0648ed2-b3de-11ec-1c49-75d404d4d53e
using ImageShow, FileIO, ImageIO

# ╔═╡ bc46c119-2e61-4c91-9600-2a4272cf65af
using RegularizationTools

# ╔═╡ 8e9ff2c4-90cb-477f-8d4a-b8ae68607142
url = ("C:\\Users\\welcome\\Desktop\\School Files\\Y3 Sem 1\\AIG\\chest_xray\\chest_xray\\train\\NORMAL\\.DS_Store")

# ╔═╡ 5bacf3fd-ea68-47f2-81ff-7cacf19ee430
url1 = 

# ╔═╡ f86df6c1-eb93-4ce7-822e-68f89f384022
normal_train_filename = (url)

# ╔═╡ 2d3e0e70-d435-4646-927d-50e715a7e44f
nor

# ╔═╡ 0e3ba899-da2d-4e72-8c3f-ba03312c6ec8
x_normal_train = load(normal_train_filename)

# ╔═╡ 3a6dd7d6-12b5-49b5-9784-175488b65e58
function reluNeuronTransformFunction(params, input)
   x = params * appendColumnOfOnes(input)
   return x .* (x .> 0)
end

# ╔═╡ 844ef37b-1fa1-48cb-b211-8e8f5bda6f89
function reluNeuronDerivativeFunction(input)
   return convert(Array{Float64,2}, input .> 0)
end

# ╔═╡ 3f065fc8-b593-4f65-a178-42d9b6ce2427
function reluComputingLayer()
  return (reluNeuronTransformFunction, reluNeuronDerivativeFunction)
end

# ╔═╡ 842b1b4f-56f7-4ebb-90d6-25745bc898b5
crossEntropies = Float64[]

# ╔═╡ d37acec6-a7be-41fd-8ca4-8d60fac4925b
architecture buildNetworkArchitecture(784, [50,10], [reluCpmputingLayer, linear])

# ╔═╡ 0e0019fb-95fc-4f1d-9cbb-e860f8087ea9
batchSize = 1341 #batchSize number of images

# ╔═╡ 522947c5-574b-41ad-8916-8f4ee2fb99d2
for i = 1:1341 #loop for layer first 5 layers
minibatch = collect((batchSize*i);(batchSize*1 +batchSize)) % size(x_normal_train, 2) #takes next elements
learningUnit = backProagationBatchLearningUnit(architecture, x_normal_train[:, minbatch],updateParameters!(learnigUnit, 0.1)
if i % 100 == 0
	push!(crossEntropies, crossEntropyError(architecture, x_normal_train))
	
end
	end

# ╔═╡ 7952f15d-e545-4e88-bf3f-f9c54c0b22c0
